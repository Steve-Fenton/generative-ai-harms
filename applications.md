...
We will use surveys to gauge the general acceptance or rejection of specific uses.

This is a list of uses that we will survey people on, with a prediction on the outcome.
...
| Filtering job applications           | Reject     |        |
| Add more!                            |            |        |
